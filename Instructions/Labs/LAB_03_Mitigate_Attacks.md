...
1. In the Microsoft Defender XDR portal expand **Investigation & response** from the left menu bar, then expand **Incidents & alerts** and select **Alerts**.
...
1. On the **WIN1** virtual machine, type **PowerShell** into the Search bar, then *right-click* **Windows PowerShell** and choose *Run as Administrator*.
...
In this lab, you verified device onboarding, generated and investigated alerts and incidents, simulated an attack, and analyzed it using the incident graph and attack story in Microsoft Defender for Endpoint.
